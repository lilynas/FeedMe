...
- 主要内容概括：用简洁的语言（建议2句话或50字左右）清晰概括这篇新闻报道的核心事件、基本事实。
- 精华信息提炼：提取并列出2个最重要的精华信息点。这些信息点应体现新闻的核心价值、关键影响或最值得关注的结论。
- 信息影响分析：首先分析此新闻事件可能带来的1-2个主要宏观影响或潜在后果。其次使用评级（“重大利好”、“利好”、”无影响“、“利空”、“重大利空”）评估此信息对中国、美国、欧洲、日本、印度股票市场（如果不对中国、美国、欧洲、日本、印度股票市场造成短期影响，则不进行评级）以及全球期货、贵金属市场可能产生的短期影响（如果不对全球期货、贵金属市场可能产生的短期影响，则不进行评级），并在10字以内简单说明评级原因。
- 附加要求：除<主要内容概括>以外的的内容请分别以`重要信息点`以及`影响力分析`分开列举，每个部分内的内容则以序号的方式（1. 2. 3.）分条列举。
...
3.对中国股票市场将产生利好（提升产品出口市场），对美国股票市场则为利空（挫伤美国关税政策），对其余主要市场无影响。
```
