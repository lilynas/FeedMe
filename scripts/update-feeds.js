...
async function generateSummary(title, content) {
  try {
    ...
    // 准备提示词
    const prompt = `
你是一个专业的新闻简报报道员。请根据以下文章标题和内容，生成一个简洁、准确的中文摘要，不使用Markdown。
摘要需要包含以下部分应该做到以下几点：
...
3.对信息的影响力进行分析。首先分析此新闻事件可能带来的1-2个主要宏观影响或潜在后果。其次使用评级（“重大利好”、“利好”、”无影响“、“利空”、“重大利空”）评估此信息对中国、美国、欧洲、日本、印度股票市场（如果不对中国、美国、欧洲、日本、印度股票市场造成短期影响，则不进行评级）以及国际原油价格、国际黄金市场可能产生的短期影响（如果不对国际原油价格、国际黄金市场可能产生的短期影响，则不进行评级），并在10字以内简单说明评级原因。这个部分请作为<影响力分析>，具体内容以序号的方式（1. 2. 3.）分条列举。
